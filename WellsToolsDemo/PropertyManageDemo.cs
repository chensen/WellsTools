...
namespace WellsToolsDemo
{
    public partial class PropertyManageDemo : Form
    {
        ...
        private void PropertyManageDemo_Load(object sender, EventArgs e)
        {
            ...
            Wells.Tools.Property pp = new Wells.Tools.Property("Name", "陈森", false, true);
            pp.Category = "我的属性1";
            pp.DisplayName = "姓名";
            pp.Description = "姓名";
            pmc.Add(pp);

            pp = new Wells.Tools.Property("Sex", "男", false, true);
            pp.Category = "我的属性1";
            pp.DisplayName = "性别";
            pp.Description = "性别";
            ...
            pp = new Wells.Tools.Property("Age", 30, false, true);
            pp.Category = "我的属性2";
            pp.DisplayName = "年龄";
            pp.Description = "年龄";
            pmc.Add(pp);

            pp = new Wells.Tools.Property("Path", "", false, true);
            pp.Category = "我的属性2";
            pp.DisplayName = "档案路径";
            pp.Description = "档案路径";
            ...
            pp = new Wells.Tools.Property("Version", "1.0.0.1", true, true);
            pp.Category = "我的属性3";
            pp.DisplayName = "版本号";
            pp.Description = "版本号";
            pmc.Add(pp);
            ...
            propertyGrid2.SelectedObject = propertyGrid1;
        }
