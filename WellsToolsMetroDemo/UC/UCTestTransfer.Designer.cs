namespace WellsToolsMetroDemo.UC
{
    partial class UCTestTransfer
    {
        ...
        {
            this.ucTransfer1 = new Wells.WellsMetroControl.Controls.UCTransfer();
            this.SuspendLayout();
            // 
            // ucTransfer1
            // 
            this.ucTransfer1.BackColor = System.Drawing.Color.White;
            this.ucTransfer1.LeftColumns = new Wells.WellsMetroControl.Controls.DataGridViewColumnEntity[0];
        ...
        private Wells.WellsMetroControl.Controls.UCTransfer ucTransfer1;
    }
}
