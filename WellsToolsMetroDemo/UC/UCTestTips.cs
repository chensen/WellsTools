...
using Wells.WellsMetroControl.Forms;
...
namespace WellsToolsMetroDemo.UC
{
    ...
    public partial class UCTestTips : UserControl
    {
        ...
        {
            ShowTips(sender as Wells.WellsMetroControl.Controls.UCBtnExt);
        }

        private void ShowTips(Wells.WellsMetroControl.Controls.UCBtnExt ucBtnExt1)
        {
            Wells.WellsMetroControl.Forms.FrmAnchorTips.ShowTips(ucBtnExt1, "测试提示信息\nLEFT", AnchorTipsLocation.LEFT, ucBtnExt1.FillColor);
