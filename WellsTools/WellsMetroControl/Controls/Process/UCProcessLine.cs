...
namespace Wells.WellsMetroControl.Controls
{
    ...
    public class UCProcessLine : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (m_valueTextType == Wells.WellsMetroControl.Controls.ValueTextType.Percent)
                strValue = ((float)Value / (float)m_maxValue).ToString("0%");
            else if (m_valueTextType == Wells.WellsMetroControl.Controls.ValueTextType.Absolute)
