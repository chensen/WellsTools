...
namespace Wells.Tools.OracleHelper
{
    ...
    {
        #region Read the connection strings from the configuration file
        ...
        #region Create a hashtable for the parameter cached
        private static Hashtable parmCache = Hashtable.Synchronized(new Hashtable());
        #endregion

        #region Execute a database query which does not include a select
        /// <summary>
        ...
        #region Execute an OracleCommand (that returns no resultset) against an existing database transaction,using the provided parameters.
        /// <summary>
        /// Execute an OracleCommand (that returns no resultset) against an existing database transaction ,using the provided parameters.
        /// </summary>
        /// <remarks>
        /// e.g.:  
        ...
        #region Execute an OracleCommand (that returns no resultset) against an existing database connection,using the provided parameters.
        /// <summary>
        /// Execute an OracleCommand (that returns no resultset) against an existing database connection ,using the provided parameters.
        /// </summary>
        /// <remarks>
        /// e.g.:  
        ...
        #region Execute a select query that will return a result set
        /// <summary>
        ...
        #region Execute an OracleCommand that returns the first column of the first record against the database specified in the connection string ,using the provided parameters.
        /// <summary>
        /// Execute an OracleCommand that returns the first column of the first record against the database specified in the connection string ,using the provided parameters.
        /// </summary>
        /// <remarks>
        /// e.g.:  
        ...
        #region Execute a OracleCommand (that returns a 1x1 resultset)  against the specified SqlTransaction,using the provided parameters.
        ///     <summary>
        ///     Execute a OracleCommand (that returns a 1x1 resultset)  against the     specified SqlTransaction,using the provided parameters.
        ///     </summary>
        ...
        #region Execute an OracleCommand that returns the first column of the first record against an existing database connection ,using the provided parameters.
        /// <summary>
        /// Execute an OracleCommand that returns the first column of the first record against an existing database connection,using the provided parameters.
        /// </summary>
        /// <remarks>
        /// e.g.:  
        ...
        #region Add a set of parameters to the cached
        /// <summary>
        ...
        #region Fetch parameters from the cache
        /// <summary>
        ...
        #region Internal function to prepare a command for execution by the database
        /// <summary>
        ...
        #region Converter to use boolean data type with Oracle
        /// <summary>
