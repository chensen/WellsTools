...
namespace Wells.Tools
{
    ...
    public static class clsFile
    {
        ...
        /// 创建网站目录
        /// </summary>
        /// <param name="dir">要创建的网站目录路径包括目录名</param>
        ...
        /// 删除网站目录
        /// </summary>
        /// <param name="dir">要删除的网站目录路径和名称</param>
        ...
        /// 删除网站文件
        /// </summary>
        /// <param name="file">要删除的网站文件路径和名称</param>
    ...
    public class clsFileCN
    {
        ...
        protected void writeTxt(string FileName, string Content)
        {
            ...
            string htmlfilename = System.Web.HttpContext.Current.Server.MapPath("Precious\\" + FileName + ".txt");　//保存文件的路径
            string str = Content;
