...
using Wells.Tools.PassWordHelper;

namespace Wells.Tools.MySqlHelper
{
    //在使用之前记得下载.NET的mysql sdk，然后引用命名空间using MySql.Data.MySqlClient就可以了
    ...
    public abstract class MySqlHelper
    {
        ...
        public static int ExecuteSqlTran(List<CommandInfo> list, List<CommandInfo> oracleCmdSqlList)
        {
            using (MySqlConnection conn = new MySqlConnection(connectionString))
            {
                ...
                try
                {
                    ...
                    bool res = OracleHelper.ExecuteSqlTran(oraConnectionString, oracleCmdSqlList);//wellstest
                    if (!res)
                    {
                        tx.Rollback();
        ...
        */
        ...
        #region 向数据库里插入图像格式的字段(和上面情况类似的另一种实例)
        /// <summary>
