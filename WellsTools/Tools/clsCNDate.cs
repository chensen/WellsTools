...
namespace Wells.Tools
{
    ...
    public class clsChinaDate
    {
        ...
        /// 获取农历
        /// </summary>
        public static clsCNDate getChinaDate(DateTime dt)
        {
            clsCNDate cd = new clsCNDate();
            int year = dt.Year;
            int month = dt.Month;
            int date = dt.Day;
    ...
    //-------------------------------------------------------------------------------
    public class clsChineseCalendar
    {
        #region 内部结构
        /// <summary>
        /// 阳历
        ...
        /// 用一个标准的公历日期来初使化
        /// </summary>
        public clsChineseCalendar(DateTime dt)
        {
            int i;
            int leap;
            int temp;
            ...
            //计算两天的基本差距
            TimeSpan ts = _date - clsChineseCalendar.MinDay;
            offset = ts.Days;
        ...
        public clsChineseCalendar(int cy, int cm, int cd, bool leapMonthFlag)
        {
