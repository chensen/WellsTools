...
{
    public static class tagCoordinateType
    {
    ...
    public static class tagImageCoordinateType
    {
        public const int LeftDown = 0;//左下角原点
        public const int LeftUp = 1;//左上角原点
    }

    public static class tagConstData
    {
